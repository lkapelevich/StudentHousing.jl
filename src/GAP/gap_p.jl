...
reduced cost.
"""
function solve_pattern_generation(d::StudentHousingData, suboptimal_rc::Bool=false)
    ...
    # =========================================================================
    function get_kp(p::Int, π::Vector{Float64})
    ...
    while best_rc > 0
        ...
        push!(λ_generated, @variable(m,
                ...
                inconstraints = [beds; convexity[best_p]],
                coefficients = [best_u * beds_needed(best_p, d); 1.0]
              )
        )
        iter += 1
    end
